...
describe('concat', () => {
  ...
  it('should combine "cloud" and "developer"', () => {
    const result = concat("cloud","developer");
    expect(result).to.equal("clouddeveloper");
  });

  it('should throw an error', () => {
    expect(()=>{ concat("", "test") }).to.throw('one string is empty')
  });
